...
function createAuthorizeUrl(responseType, state, nonce, redirectUri, clientId, { fluxUrl }) {
...
function getAuthorizeUrl(state, nonce, clientId, redirectUri, options = {}) {
  ...
  return createAuthorizeUrl(responseType, state, nonce, redirectUri, clientId, { fluxUrl });
}
